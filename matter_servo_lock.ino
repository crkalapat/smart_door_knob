...
std::vector<int> passcode = {1, 1, 3, 2};
...
void set_servo_angle(int angle) {
  ...
  for (int i = 0; i < 20; i++) {
    ...
    // bool firstDelayCompleted = false;
    // if (currentMicros - previousMicros >= pulseWidth) {
    ...
    // digitalWrite(servoPin, servoState);
    // if (currentMicros - previousMicros > pulseWidth && !firstDelayCompleted) {
    //   previousMicros = currentMicros;
    //   servoState = LOW;
    //   digitalWrite(servoPin, servoState);
    //   firstDelayCompleted = true;
    // }
    // else if (currentMicros - previousMicros > 20000-pulseWidth && firstDelayCompleted) {
    //   previousMicros = currentMicros;
    //   servoState = HIGH;
    //   digitalWrite(servoPin, servoState);
    //   i++;
  ...
  //   if (servoState == HIGH && currentMicros - previousMicros >= pulseWidth) {
  //     // Time to turn the LED off
  //     servoState = LOW;
  //     previousMicros = currentMicros;  // Save the current time
  //     digitalWrite(servoPin, servoState);       // Turn the LED off
  //   }
  //   else if (servoState == LOW && currentMicros - previousMicros >= 20000-pulseWidth) {
  //     // Time to turn the LED on
  //     servoState = HIGH;
  //     previousMicros = currentMicros;  // Save the current time
  //     digitalWrite(servoPin, servoState);      // Turn the LED on
  //     i++;
  //   }
  // }
